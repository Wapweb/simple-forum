...
<div class="navbar navbar-inverse navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?=HOME?>">ABITua.com</a>
        </div>
        <div class="collapse navbar-collapse">
            ...
            <?php if($User->level > 0):?>
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="<?=HOME?>/User/profile/<?=$User->login?>" class="dropdown-toggle" data-toggle="dropdown"><?=$User->login?>
                            <?php
                                $newEmails = EmailModel::hasUserNewEmail($User);
                            ?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php endif; ?>
                            <li><a href="<?=HOME?>/User/profile/<?=$User->login?>">Профиль</a></li>
