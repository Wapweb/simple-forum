...
<div class="container">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Топик: <?=$topic->name?>
            <a href="<?=HOME?>/topic/edit/<?=$topic->getId()?>" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit" title="Редактировать топик"></span></a>
            <a href="<?=HOME?>/topic/delete/<?=$topic->getId()?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove" title="Удалить топик"></span></a></li>
    </ol>
    <h3><?=$topic->name?></h3>
    <?php
    if($this->navigation != "")
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-md-offset-1 col-md-11">
                        <div class="text-right">
                            ...
                            <a href="<?=HOME?>/message/edit/<?=$msg->getId()?>" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit" title="Редактировать топик"></span></a>
                            <a href="<?=HOME?>/message/delete/<?=$msg->getId()?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove" title="Редактировать топик"></span></a>
                        </div>
                    </div>
                </div>
            </div>
