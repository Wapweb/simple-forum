...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading"><div class="text-center"><a href="<?=HOME?>/mail"><strong>Почта</strong></a> &mdash; отправленные письма</div></div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="<?=HOME?>/mail/sent"><span class="glyphicon glyphicon-arrow-up"></span> Отправленные</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-12">
                            <?php if(count($emails) > 0):?>
                                ...
                                <?php endif;?>
                            <?php else: ?>
                                <div class="alert alert-info">Отправленных сообщений пока нет <a href="<?=HOME?>/mail/compose" class="alert-link">Написать письмо</a> </div>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
